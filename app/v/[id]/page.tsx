...
export default async function Video({ params }: PageProps) {
	...
	const jsonLd = {
        ...
        url: `https://bokepguruhijab.pages.dev/v/${file.filecode}#${file.title}`,
